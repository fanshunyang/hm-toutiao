...
<div class="post-detail">
    ...
    <div class="main">
      ...
      <div class="post-info">
        ...
        <span>{{post.create_date | item}}</span>
      </div>
      <!-- 新闻内容 -->
      <!--
    ...
    <div class="post-commnet">
      ...
      <!-- 评论组件 -->
      <!-- 把需要渲染的评论的数据传递给评论组件 -->
      <comment v-for="item in commentList" :key="item.id" :comment="item"  @back="revert"></comment>
    </div>
    <!-- 底部区域 -->
    <div class="footer">
      ...
      <div class="comment-textarea" v-show="isFocus">
        <textarea ref="textarea" rows="3" placeholder="回复" @blur="handleBlur" v-model="impedance"></textarea>
        <div class="send" @click="transmit">发送</div>
      </div>
    </div>
  </div>
